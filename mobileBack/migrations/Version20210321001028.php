 ...
 */
final class Version20210321001028 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD isRetired TINYINT(1) DEFAULT NULL, CHANGE date_retrait date_retrait DATE DEFAULT NULL, CHANGE frais frais INT DEFAULT NULL, CHANGE frais_depot frais_depot INT DEFAULT NULL, CHANGE frais_retrait frais_retrait INT DEFAULT NULL, CHANGE frais_etat frais_etat INT DEFAULT NULL, CHANGE frais_systeme frais_systeme INT DEFAULT NULL');
