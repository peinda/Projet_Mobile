 ...
 */
final class Version20210320183556 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD is_retired TINYINT(1) DEFAULT NULL, CHANGE date_retrait date_retrait DATE NOT NULL, CHANGE frais frais INT NOT NULL, CHANGE frais_depot frais_depot INT NOT NULL, CHANGE frais_retrait frais_retrait INT NOT NULL, CHANGE frais_etat frais_etat INT NOT NULL, CHANGE frais_systeme frais_systeme INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction DROP is_retired, CHANGE date_retrait date_retrait DATE DEFAULT NULL, CHANGE frais frais INT DEFAULT NULL, CHANGE frais_depot frais_depot INT DEFAULT NULL, CHANGE frais_retrait frais_retrait INT DEFAULT NULL, CHANGE frais_etat frais_etat INT DEFAULT NULL, CHANGE frais_systeme frais_systeme INT DEFAULT NULL');
